...
{
    // Diffuse texture
    float4 texCol = diffuseTex.Sample(linearSampler, psIn.inTexCoords);
    ...
    return float4(saturate(finalAmbientColor + finalDiffuseColor + finalSpecularColor) * texCol.xyz, 1.0f);
}